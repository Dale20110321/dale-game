...
function makeEl(id){return {id,style:{},_cls:new Set(["hidden"]),children:[],
  ...
  textContent:"",innerHTML:"",width:0,height:0,addEventListener(){},appendChild(){},getContext(){return ctxStub;},disabled:false,dataset:{},parentNode:{style:{}}}};
...
globalThis.document=doc;globalThis.window={addEventListener(){},devicePixelRatio:1,innerWidth:1280,innerHeight:800,AudioContext:function(){},webkitAudioContext:function(){},requestAnimationFrame(){},setTimeout(){},matchMedia:()=>({matches:false})};
...
try{
  new Function("document","window","navigator","localStorage","requestAnimationFrame","addEventListener","innerWidth","innerHeight",code)(doc,globalThis.window,navigator,globalThis.localStorage,(fn)=>{},()=>{},1280,800);
  console.log("✅ 脚本完整执行无错误！关卡可以点击！");
}catch(e){
